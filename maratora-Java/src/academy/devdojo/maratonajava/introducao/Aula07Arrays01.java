...
public class Aula07Arrays01 {
    public static void main(String[] args) {
        ...
        // 4️⃣ Percorrendo o array com for tradicional
        ...
        // 5️⃣ Percorrendo o array com for-each
        ...
        // 6️⃣ Alterando um valor do array
        ...
        // 7️⃣ Somando todos os valores do array
        int soma = 0;
        for (int numero : numeros) {
            soma += numero;
        }
        ...
        // 8️⃣ Calculando a média dos valores
        double media = (double) soma / numeros.length;
        System.out.println("Média dos valores: " + media);

        System.out.println("---------------------------");

        // 9️⃣ Verificando números maiores que 25
